...
namespace Ronnie
{
	...
	void InputLayout::Initialize(ID3D11Device* device, D3D11_INPUT_ELEMENT_DESC* layout, uint32 count, ID3DBlob* vertexShaderBuffer)
	{
	...
	void InputLayout::Initialize(ID3D11Device* device, ID3DBlob* vertexShaderBuffer)
	{
		...
		{
			D3D11_SIGNATURE_PARAMETER_DESC parameterDesc = { 0 };
