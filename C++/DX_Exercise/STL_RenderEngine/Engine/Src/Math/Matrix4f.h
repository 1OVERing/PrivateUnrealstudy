...
namespace Ronnie
{
	...
	public:
		...
		static Matrix4f InverseRotationMatrix(const Vector3f& rotation);
		...
		static Matrix4f Orthographic(float width, float height, float zNear, float zFar);
